...
const variants: Record<ButtonVariant, string> = {
  ...
  acid:
    'inline-flex items-center justify-center gap-3 bg-acid px-4 py-3 font-mono text-[11px] uppercase tracking-[0.2em] text-soot transition-colors hover:bg-bone disabled:cursor-not-allowed disabled:opacity-60',
  outline:
